package com.talktomem2.web.rest;

import com.talktomem2.domain.C;
import com.talktomem2.repository.CRepository;
import com.talktomem2.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.talktomem2.domain.C}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CResource {
    ...
    private static final String ENTITY_NAME = "talktomem2C";
