  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="talaktomeApp.b.home.createOrEditLabel" data-cy="BCreateUpdateHeading">
            <Translate contentKey="talaktomeApp.b.home.createOrEditLabel">Create or edit a B</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : bEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="b-a" data-cy="a" type="select" className="form-control" name="aId">
                  <option value="" key="0" />
                  {as
                    ? as.map(otherEntity => (
