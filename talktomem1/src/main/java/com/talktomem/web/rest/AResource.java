...
import com.talktomem.domain.A;
import com.talktomem.repository.ARepository;
...
/**
 * REST controller for managing {@link com.talktomem.domain.A}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AResource {
    ...
    private static final String ENTITY_NAME = "talktomem1A";
