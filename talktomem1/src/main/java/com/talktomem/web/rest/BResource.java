...
import com.talktomem.repository.BRepository;
...
/**
 * REST controller for managing {@link com.talktomem.domain.B}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BResource {
    ...
    private static final String ENTITY_NAME = "talktomem1B";
